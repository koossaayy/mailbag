<div class="flex -mx-3">
    ...
    <div class="flex-auto px-3">
        ...
        <div class="pt-5">
            ...
            <p class="text-xs text-gray-500">
                {{ __('The name used for your own reference.') }}
            </p>
        ...
        <div class="pt-5">
            ...
            <p class="text-xs text-gray-500">
                {{ __('The name that will be shown to contacts on things like the sign-up form.') }}
            </p>
        ...
        <div class="pt-5">
            ...
            <p class="text-xs text-gray-500">
                {{ __('Used in the URLs for the sign-up form.') }} <br>
                {{ __('If this is left empty the URL slug will be automatically generated from the display name.') }}
            </p>
    ...
    <div class="flex-auto px-3">
        ...
        <div class="pt-5">
            ...
            <p class="text-xs text-gray-500">
                {{ __('This will be shown to contacts to describe what kind of content they will receive.') }}
            </p>
